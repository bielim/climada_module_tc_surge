function hazard=tc_surge_hazard_create(hazard,hazard_set_file,elevation_data,check_plots)
...
%
% CALLING SEQUENCE:
%   hazard=tc_surge_hazard_create(hazard,hazard_set_file,elevation_data,check_plot)
% EXAMPLE:
